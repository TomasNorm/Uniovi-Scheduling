import time # para consultar el reloj del sistema
...
"""
# Ejemplo
Tiempo.inicia() # inicia el cronómetro

time.sleep(2) # duerme 2 segundos
print(f"Tiempo acumulado: {Tiempo.actual():.03f}") # lectura actual

time.sleep(1) # duerme 1 segundo
print(f"Tiempo acumulado: {Tiempo.actual():.03f}") # lectura actual

Tiempo.finaliza() # detiene el cronómetro
print(f"Tiempo total: {Tiempo.total()}") # lectura final"""