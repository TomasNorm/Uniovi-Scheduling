...
from BPPProblem import BPPProblem, BPPCreatorRandom, BPPDecoder,  BPPEvaluator
...
class BPPConfiguration:
    ...
    creator = BPPCreatorRandom(problem)

    # decodificacion y evaluacion
    decoder = BPPDecoder(problem)
