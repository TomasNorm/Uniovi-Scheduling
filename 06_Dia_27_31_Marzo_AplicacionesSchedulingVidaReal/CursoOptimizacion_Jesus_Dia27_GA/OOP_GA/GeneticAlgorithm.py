...
class GeneticAlgorithm:
    ...
    def run(self):
        ...
        while gen<self.cfg.max_gen and Tiempo.actual() < self.cfg.tiempo_maximo:
            poblacion2 = self.__seleccion(poblacion)
        ...
        return poblacion[self.pos_mejor_cromosoma].genotipo, poblacion[self.pos_mejor_cromosoma].fitness, self.evolucion_mejor_media_peor_fitness
